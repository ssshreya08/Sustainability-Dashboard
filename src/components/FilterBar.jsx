  ...
  return (
    <div className="flex flex-wrap gap-3 items-end mb-4">
      ...
      <div>
        ...
        <select value={filters.department || ""} onChange={onChange("department")}
                className="border rounded px-2 py-1">
      ...
      <div>
        ...
        <select value={filters.unit || ""} onChange={onChange("unit")}
                className="border rounded px-2 py-1">
          <option value="">All</option>
      ...
      <div>
        ...
        <select value={filters.machine || ""} onChange={onChange("machine")}
                className="border rounded px-2 py-1">
          <option value="">All</option>
      ...
      <div>
        ...
        <select value={filters.shift || ""} onChange={onChange("shift")}
                className="border rounded px-2 py-1">
          <option value="">All</option>
      ...
      <button
        ...
        onClick={() => setFilters({ from: null, to: null, department: null, unit: null, machine: null, shift: null })}>
        Reset
      </button>
    </div>
  );
